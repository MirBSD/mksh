#!/bin/sh
srcversion='$MirOS: src/bin/mksh/Build.sh,v 1.616.2.1 2013/02/11 17:25:00 tg Exp $'
#-
...
if test $cm = makefile; then
	...
	cat >conftest.c <<-'EOF'
		...
		#include "sh.h"
		__RCSID("$MirOS: src/bin/mksh/Build.sh,v 1.616.2.1 2013/02/11 17:25:00 tg Exp $");
