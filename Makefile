# $MirOS: src/bin/mksh/Makefile,v 1.184 2021/08/19 00:36:47 tg Exp $
#-
...
CPPFLAGS+=	-DMKSH_ASSUME_UTF8 -DMKSH_DISABLE_DEPRECATED \
		...
		-DHAVE_SYS_PTEM_H=0 -DHAVE_SYS_RESOURCE_H=1 \
		...
		-DHAVE_CAN_INTTYPES=1 -DHAVE_CAN_UCBINTS=1 -DHAVE_SIG_T=1 \
		-DHAVE_SYS_ERRLIST=1 -DHAVE_SYS_SIGNAME=1 \
		-DHAVE_SYS_SIGLIST=1 -DHAVE_FLOCK=1 -DHAVE_LOCK_FCNTL=1 \
		-DHAVE_RLIMIT=1 -DHAVE_RLIM_T=1 -DHAVE_GETRUSAGE=1 \
		-DHAVE_GETSID=1 -DHAVE_GETTIMEOFDAY=1 -DHAVE_KILLPG=1 \
		-DHAVE_MEMMOVE=1 -DHAVE_BCOPY=1 -DHAVE_MKNOD=0 -DHAVE_MMAP=1 \
		...
		-DHAVE_SETGROUPS=1 -DHAVE_SIGACTION=1 -DHAVE_STRERROR=0 \
		-DHAVE_STRSIGNAL=0 -DHAVE_STRLCPY=1 -DHAVE_STRSTR=1 \
		-DHAVE_FLOCK_DECL=1 -DHAVE_REVOKE_DECL=1 \
		-DHAVE_SYS_ERRLIST_DECL=1 -DHAVE_SYS_SIGLIST_DECL=1 \
		-DHAVE_ST_MTIMENSEC=1 -DHAVE_PERSISTENT_HISTORY=1 \
		-DMKSH_BUILD_R=599
