# $MirOS: src/bin/mksh/Makefile,v 1.200 2025/12/23 19:26:15 tg Exp $
#-
...
CPPFLAGS+=	-DMKSH_DISABLE_DEPRECATED \
		...
		-DHAVE_ULIMIT_H=0 -DHAVE_SIG_T=1 -DHAVE_STRERRORDESC_NP=0 \
		-DHAVE_SYS_ERRLIST=1 -DHAVE_SIGABBREV_NP=0 \
		-DHAVE_SYS_SIGNAME=1 -DHAVE_SIGDESCR_NP=0 \
		-DHAVE_SYS_SIGLIST=1 -DHAVE_FLOCK=1 -DHAVE_LOCK_FCNTL=1 \
		-DHAVE_RLIMIT=1 -DHAVE_GET_CURRENT_DIR_NAME=0 \
		-DHAVE_GETRANDOM=0 -DHAVE_GETRUSAGE=1 -DHAVE_GETSID=1 \
		-DHAVE_GETTIMEOFDAY=1 -DHAVE_KILLPG=1 -DHAVE_MEMMOVE=1 \
		-DHAVE_MKNOD=0 -DHAVE_MMAP=1 -DHAVE_FTRUNCATE=1 -DHAVE_NICE=1 \
		-DHAVE_RENAME=1 -DHAVE_REVOKE=1 -DHAVE_POSIX_UTF8_LOCALE=1 \
		-DHAVE_SELECT=1 -DHAVE_SETRESUGID=1 -DHAVE_SETGROUPS=1 \
		-DHAVE_SIGACTION=1 -DHAVE_STRERROR=0 -DHAVE_STRSIGNAL=0 \
		-DHAVE_STRLCPY=1 -DHAVE_STRSTR=1 -DHAVE_FLOCK_DECL=1 \
		-DHAVE_REVOKE_DECL=1 -DHAVE_SYS_ERRLIST_DECL=1 \
		-DHAVE_SYS_SIGLIST_DECL=1 -DHAVE_ST_MTIMENSEC=1 \
		-DHAVE_INTCONSTEXPR_RSIZE_MAX=1 -DHAVE_PERSISTENT_HISTORY=1 \
		-DMKSH_BUILD_R=599
