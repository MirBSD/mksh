# $MirOS: src/bin/mksh/Makefile,v 1.193 2023/03/14 15:09:15 tg Exp $
#-
...
CPPFLAGS+=	-DMKSH_DISABLE_DEPRECATED \
		...
		-DHAVE_SIG_T=1 -DHAVE_STRERRORDESC_NP=0 -DHAVE_SYS_ERRLIST=1 \
		...
		-DHAVE_GET_CURRENT_DIR_NAME=0 -DHAVE_GETRUSAGE=1 \
