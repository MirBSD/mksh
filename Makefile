# $MirOS: src/bin/mksh/Makefile,v 1.189 2021/11/14 04:33:23 tg Exp $
#-
...
CPPFLAGS+=	-DMKSH_DISABLE_DEPRECATED \
		...
		-DHAVE_SYS_SIGNAME=1 -DHAVE_SYS_SIGLIST=1 -DHAVE_FLOCK=1 \
		-DHAVE_LOCK_FCNTL=1 -DHAVE_RLIMIT=1 -DHAVE_RLIM_T=1 \
